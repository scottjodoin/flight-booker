...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { age: @passenger.age, email: @passenger.email, name: @passenger.name, passport: @passenger.passport } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { age: @passenger.age, email: @passenger.email, name: @passenger.name, passport: @passenger.passport } }
